...
// This excellent script pulled from:
// http://www.fantasynamegenerators.com/haiku-generator.php
// By Emily

// 171021 - Modified by Karim Sultan
...
// Output
var tone = ["? ", "? ", ". ", ", ", "! ", "! "];
var tone1 = (Math.random() * tone.length | 0);
var tone2 = (Math.random() * tone.length | 0);

// TTS has problems unless last line (very last char) is a "."
//var tone3 = (Math.random() * tone.length | 0);
lyrics = names1 + tone[tone1] + names2 + tone[tone2] + names3 + "."; //tone[tone3];
